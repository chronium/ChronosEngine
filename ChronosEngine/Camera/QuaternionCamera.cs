...
namespace ChronosEngine.Camera {
	public class QuaternionCamera : ICamera {
		...
		public bool MouseLookEnabled { get { return m_MouseLookEnabled; } set { m_MouseLookEnabled = value; if (MouseLookEnabled) { Cursor.Hide(); ResetMouse(); } else Cursor.Show(); } }
		...
		protected Point WindowCenter { get { return new Point((m_ParentGame.ClientRectangle.Left + m_ParentGame.ClientRectangle.Right) / 2, (m_ParentGame.ClientRectangle.Top + m_ParentGame.ClientRectangle.Bottom) / 2); } }
